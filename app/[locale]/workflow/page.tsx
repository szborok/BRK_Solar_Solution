  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        >
          <source src="/media_collection/hero/3621131449-preview.mp4" type="video/mp4" />
        </video>
      ...
      <section className="py-24 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-6xl text-center relative z-10">
          <h2 className="text-5xl font-bold text-dark-700 mb-3 sm:mb-4 bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent" style={{ textShadow: '2px 2px 4px rgba(0,0,0,0.1)' }}>{t('overview.title')}</h2>
