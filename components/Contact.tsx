    ...
    <section id="contact" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-5xl mx-auto">
          {activeForm === 'contact' ? (
            // Simple Contact Form
            <div className="bg-white/95 backdrop-blur-sm text-gray-900 p-8 md:p-12 rounded-2xl shadow-2xl">
              ...
              <form onSubmit={handleContactSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-600 focus:border-transparent transition-all resize-none"
                ...
                <button
                  ...
                  className="w-full bg-accent-600 hover:bg-accent-700 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                >
